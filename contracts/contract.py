...
class MarsSurvivalGame(gl.Contract):
    ...
    def judge_survival(self, user_answers: str) -> str:
        ...
        # SECURITY: always use the scenario we generated and stored for this
        # user; never trust a scenario string supplied by the caller, or a
        # player could submit an easy scenario of their own choosing to
        # game the verdict.
        try:
            ...
            scenario = ""
        if not scenario:
            raise Exception("No scenario found for this address. Call generate_scenario first.")
